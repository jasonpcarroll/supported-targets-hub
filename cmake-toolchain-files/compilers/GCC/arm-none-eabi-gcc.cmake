...
if(NOT TOOLCHAIN_FOUND)
    ...
    set(C_COMPILER_PATH "${TOOLCHAIN_DIR}/bin/arm-none-eabi-gcc${EXECUTABLE_ENDING}")
    set(C_DEBUGGER_PATH "${TOOLCHAIN_DIR}/bin/arm-none-eabi-gdb${EXECUTABLE_ENDING}")
    set(ASM_COMPILER_PATH "${TOOLCHAIN_DIR}/bin/arm-none-eabi-gcc${EXECUTABLE_ENDING}")
    set(ASM_DEBUGGER_PATH "${TOOLCHAIN_DIR}/bin/arm-none-eabi-gdb${EXECUTABLE_ENDING}")
    set(CXX_COMPILER_PATH "${TOOLCHAIN_DIR}/bin/arm-none-eabi-g++${EXECUTABLE_ENDING}")
    set(CXX_DEBUGGER_PATH "${TOOLCHAIN_DIR}/bin/arm-none-eabi-gdb${EXECUTABLE_ENDING}")
    set(AR_PATH "${TOOLCHAIN_DIR}/bin/arm-none-eabi-gcc-ar${EXECUTABLE_ENDING}")
    set(RANLIB_PATH "${TOOLCHAIN_DIR}/bin/arm-none-eabi-gcc-ranlib${EXECUTABLE_ENDING}")
    set(OBJCOPY_PATH "${TOOLCHAIN_DIR}/bin/arm-none-eabi-objcopy${EXECUTABLE_ENDING}")
    set(SIZE_UTIL_PATH "${TOOLCHAIN_DIR}/bin/arm-none-eabi-size${EXECUTABLE_ENDING}")
endif()
