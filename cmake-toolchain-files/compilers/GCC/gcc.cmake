...
if(NOT TOOLCHAIN_FOUND)
  if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux")
    ...
    if(HOST_ARCH STREQUAL "x86_64")
      set(TOOLCHAIN_URL
          "https://github.com/xpack-dev-tools/gcc-xpack/releases/download/v15.2.0-1/xpack-gcc-15.2.0-1-linux-x64.tar.gz"
      )
      set(TOOLCHAIN_FOLDER "xpack-gcc-15.2.0-1")
    elseif(HOST_ARCH STREQUAL "aarch64")
      set(TOOLCHAIN_URL
          "https://github.com/xpack-dev-tools/gcc-xpack/releases/download/v15.2.0-1/xpack-gcc-15.2.0-1-linux-arm64.tar.gz"
      )
      set(TOOLCHAIN_FOLDER "xpack-gcc-15.2.0-1")
    endif()
  elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows")
    add_compile_definitions(NO_SYS_TIMES)
  ...
  if(NOT EXISTS "${TOOLCHAIN_DIR}")
    message(
      STATUS
        "Downloading GCC toolchain for ${CMAKE_HOST_SYSTEM_NAME} ${HOST_ARCH}..."
    )
