...
if(NOT TOOLCHAIN_FOUND)
    ...
    elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows")
        ...
        if(HOST_ARCH STREQUAL "x86_64")
            set(TOOLCHAIN_URL "https://github.com/xpack-dev-tools/gcc-xpack/releases/download/v15.2.0-1/xpack-gcc-15.2.0-1-win32-x64.zip")
            set(TOOLCHAIN_FOLDER "xpack-gcc-15.2.0-1")
        endif()
    ...
    set(C_COMPILER_PATH "${TOOLCHAIN_DIR}/bin/gcc")
    set(C_DEBUGGER_PATH "${TOOLCHAIN_DIR}/bin/gdb")
    set(ASM_COMPILER_PATH "${TOOLCHAIN_DIR}/bin/gcc")
    set(ASM_DEBUGGER_PATH "${TOOLCHAIN_DIR}/bin/gdb")
    set(CXX_COMPILER_PATH "${TOOLCHAIN_DIR}/bin/g++")
    set(CXX_DEBUGGER_PATH "${TOOLCHAIN_DIR}/bin/gdb")
    set(AR_PATH "${TOOLCHAIN_DIR}/bin/gcc-ar")
    set(RANLIB_PATH "${TOOLCHAIN_DIR}/bin/gcc-ranlib")
    set(OBJCOPY_PATH "${TOOLCHAIN_DIR}/bin/objcopy")
    set(SIZE_UTIL_PATH "${TOOLCHAIN_DIR}/bin/size")
endif()
